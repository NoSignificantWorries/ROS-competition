...
def main():
    ...
    points_conf = {
        ...
        "l4": (225, 250),
        "r8": (200, 277),
        "l5": (80, 285), # перед конусами
        "l9": (43, 330),
        "l10": (70, 365),
        "l11": (40, 395),
        "l12": (70, 425), 
        "l6": (70, 483), # конец конусов, перед машиной
        "l7": (290 ,483),
        "l8": (330, 465), # after car
        "l13": (365, 485),
        "r14": (410, 485),
        "l14": (472, 475),
        "r15": (485, 430),
        "r16": (470, 405),  # ArUco
        "l15.0": (460, 405),  # ArUco detect
        "l15.1": (390, 405),
        "l15": (350, 405),
        "r17": (295, 385),
        "l16": (295, 310),
    ...
    with open("path.json", "w") as file:
        json.dump({"events": events} | compiled_points, file, indent=2)
